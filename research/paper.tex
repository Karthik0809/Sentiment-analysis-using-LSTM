...
and orchestrated via Docker Compose, enabling one-command local deployment.
A \textbf{GitHub Actions} workflow automatically runs the full test
suite on Python 3.10 and 3.11 on every push and pull request, ensuring
regressions in preprocessing and model inference are caught before merge.
